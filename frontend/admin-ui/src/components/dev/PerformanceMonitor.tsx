...
export function PerformanceMonitor() {
  ...
  if (!isVisible) {
    return (
      <button
        ...
        className="fixed bottom-4 left-4 bg-blue-600 text-white px-3 py-2 rounded-lg text-xs font-medium shadow-lg hover:bg-blue-700 transition-colors z-50"
  ...
  return (
    <div className="fixed bottom-4 left-4 bg-white border border-gray-200 rounded-lg shadow-lg p-4 max-w-sm z-50 text-sm">
      ...
      {metrics && (
        <div className="space-y-2 mb-4">
          <h4 className="font-medium text-gray-800">Loading Times</h4>
          <div className="space-y-1 text-xs">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600">Total Page Load:</span>
