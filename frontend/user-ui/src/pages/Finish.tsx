    ...
    <div className="relative min-h-screen w-screen overflow-y-auto bg-gradient-to-br from-gray-900 via-green-900 to-gray-900">
      ...
      <header className="absolute top-0 w-full flex justify-between items-center p-8 z-10" dir="rtl">
        ...
        <div className="flex-1 flex justify-end items-center gap-4">
          <div className="px-4 py-2 bg-green-500/20 backdrop-blur-sm border border-green-400/30 rounded-full text-green-300 text-sm font-medium">
            اكتمل الاختبار
          </div>
          <img 
            src="/FB-ICON.png" 
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-6">
            <div className="flex justify-center">
              <div className="w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center shadow-2xl animate-pulse">
                <CheckCircle className="h-14 w-14 text-white" />
              </div>
            </div>
            
            <h1 className="text-4xl font-bold text-green-300 leading-tight" dir="rtl">
              {strings.finish.title}
            </h1>
            <p className="text-xl text-green-200 max-w-2xl mx-auto leading-relaxed" dir="rtl">
          ...
          <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 backdrop-blur-sm rounded-xl p-6 border border-green-400/30">
            <p className="text-center text-white leading-relaxed font-medium" dir="rtl">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 overflow-hidden">
            <div className="p-6 border-b border-white/20">
              <h2 className="text-lg font-semibold text-white flex items-center gap-2" dir="rtl">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md mx-auto">
              <button 
                ...
                className="bg-gradient-to-r from-green-500 to-emerald-400 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-2"
              >
              ...
              <button 
                ...
                className="bg-white/10 backdrop-blur-sm border border-white/30 text-white font-bold py-3 px-6 rounded-lg hover:bg-white/20 transition-all duration-300 flex items-center justify-center gap-2"
              >
